        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="animate-fade-in">
              <h2 className="sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 text-foreground leading-tight py-[1px] text-4xl">Комфортное питание без строгих диет и ограничений, для ваших целей</h2>
...
Веду здоровый образ жизни, активно занимаюсь спортом. Более 15 лет я сам придерживаюсь правильного питания, и теперь, как специалист по питанию, хочу поделиться с вами своими знаниями и опытом.
      ...
      <section className="py-20 px-4 bg-muted">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4 text-foreground">🍴 Забудьте про строгие диеты и голодовки!</h2>
